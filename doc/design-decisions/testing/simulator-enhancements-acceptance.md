...
| 6 Python Provider 研究 | 前五项完成后在独立分支研究，明确三类 Provider 的接入、性能、异常和契约边界，以实验支撑结论 | 独立分支 codex/python-provider-research 完成[原型实验](python-provider-research.md)；未接入产品 UI |
