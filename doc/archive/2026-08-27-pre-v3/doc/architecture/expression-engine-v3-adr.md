...
| evaluate | `MISSING_VALUE`、`INVALID_PROGRAM`、`QUERY_BIND`、`INDEX_LOOKUP`、`NONFINITE_SCORE`、`PROVIDER_ERROR`、`PROVIDER_PANIC`、`PROVIDER_CANCELED`、`MATCH_FACT_INCOMPLETE`、`FACT_VALUE_LIMIT` |
